  ...
  window.__ModuleLoader__.load({
    ...
    factory: (require2) => {
        ...
        descriptors: [
          {
            ...
            sourceLocation: { file: "dsh-archive-manager-plus/lib/workspace.js", line: 1, column: 1 }
          },
          {
          ...
          },
          {
            ...
            parameters: [{
              ...
              wire: "target",
              source: "json",
              codec: { mode: "strict", typeSymbol: "dsh-archive-manager-plus/types#ArchivedBatchTarget", schema: archivedBatchTargetSchema }
            }],
            result: {
              mode: "strict",
      ...
      if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("dsh-archive-manager/Archived.module.css") + "]") === null) {
        ...
        tag.dataset.plugin = "dsh-archive-manager-plus";
      ...
      const tagId$2 = "dsh-archive-manager-plus/Rows.module.css";
      ...
      const tagId$1 = "dsh-archive-manager-plus/WorkspacePicker.module.css";
      ...
      const tagId = "dsh-archive-manager-plus/WorkspaceBrowser.module.css";
      ...
      const SESSION_PATH_ENDPOINT = "/api/dsh-archive-manager-plus/session-path";
      ...
      const SESSION_DIGEST_ENDPOINT = "/api/dsh-archive-manager-plus/session-digest";
      ...
      const TURN_COUNTS_ENDPOINT = "/api/dsh-archive-manager-plus/archived-turn-counts";

  ...
  window.__ModuleLoader__.load({
    ...
    factory: (require2) => {
      ...
      const ARCHIVE_MANAGER_REMOTE = {
        package: "dsh-archive-manager-pro",
        descriptors: [
          {
            id: "dsh-archive-manager-pro#workspaceRegistry/unarchiveSession",
            ...
            result: {
              mode: "strict",
              typeSymbol: "dsh-archive-manager-pro/types#ArchivedSessionIds",
              schema: archivedSetSchema
            },
            sourceLocation: { file: "dsh-archive-manager-pro/lib/workspace.js", line: 1, column: 1 }
          },
          {
            id: "dsh-archive-manager-pro#workspaceRegistry/deleteSession",
            service: "workspaceRegistry",
            namespace: "workspaceRegistry",
            ...
            result: {
              mode: "strict",
              typeSymbol: "dsh-archive-manager-pro/types#Deleted",
              schema: deletedSchema
            },
            sourceLocation: { file: "dsh-archive-manager-pro/lib/workspace.js", line: 1, column: 1 }
          },
          {
            id: "dsh-archive-manager-pro#workspaceRegistry/unarchiveSessions",
            service: "workspaceRegistry",
            namespace: "workspaceRegistry",
            ...
            parameters: [{
              ...
              wire: "target",
              source: "json",
              codec: { mode: "strict", typeSymbol: "dsh-archive-manager-pro/types#ArchivedBatchTarget", schema: archivedBatchTargetSchema }
            }],
            result: {
              mode: "strict",
              typeSymbol: "dsh-archive-manager-pro/types#UnarchivedBatch",
              schema: unarchivedBatchSchema
            },
            sourceLocation: { file: "dsh-archive-manager-pro/lib/workspace.js", line: 1, column: 1 }
          },
          {
            id: "dsh-archive-manager-pro#workspaceRegistry/archiveWorkspaceSessions",
            service: "workspaceRegistry",
            namespace: "workspaceRegistry",
            ...
            result: {
              mode: "strict",
              typeSymbol: "dsh-archive-manager-pro/types#ArchivedWorkspaceBatch",
              schema: archivedWorkspaceBatchSchema
            },
            sourceLocation: { file: "dsh-archive-manager-pro/lib/workspace.js", line: 1, column: 1 }
          },
          {
            id: "dsh-archive-manager-pro#workspaceRegistry/deleteArchivedSessions",
            service: "workspaceRegistry",
            namespace: "workspaceRegistry",
            ...
            result: {
              mode: "strict",
              typeSymbol: "dsh-archive-manager-pro/types#DeletedBatch",
              schema: deletedBatchSchema
            },
            sourceLocation: { file: "dsh-archive-manager-pro/lib/workspace.js", line: 1, column: 1 }
          },
          {
            id: "dsh-archive-manager-pro#workspaceRegistry/archivedSessionMetadata",
            service: "workspaceRegistry",
            namespace: "workspaceRegistry",
            ...
            result: {
              mode: "strict",
              typeSymbol: "dsh-archive-manager-pro/types#ArchivedSessionMetadata",
      ...
      if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify("dsh-archive-manager/Archived.module.css") + "]") === null) {
        ...
        tag.dataset.plugin = "dsh-archive-manager-pro";
      ...
      function ArchivedSessionsSection({ sessionStore, workspaceStore, unarchiveSession, deleteSession, unarchiveSessions, deleteArchivedSessions, deleteArchivedSessionsInBatches, deleteArchivedSessionsSafe, archivedSessionMetadata, archiveSessionsByIds, archiveSessionsBatch, openConversation, viewState, close, t }) {
        ...
        (0, react.useEffect)(() => {
          if (workspaceState.archivedSessionIds.length === 0) return;
          let cancelled = false;
        ...
        const viewConversation = async (session, restore = false) => {
          ...
          setError(null);
          try {
            await openArchivedConversation({ restore: unarchiveSession, open: async (id) => {
              await openConversation(id);
              if (navigationActive.current) close?.();
            } }, session.id, restore, () => navigationActive.current);
          } catch (reason) {
            if (navigationActive.current) setError(formatArchiveNavigationError(reason, t));
          } finally {
        ...
        const sortedGroups = (0, react.useMemo)(() => sortArchivedGroups(groups, sortBy, createdAtById, t, turnCountById), [groups, sortBy, createdAtById, t, turnCountById]);
        (0, react.useEffect)(() => {
          let cancelled = false;
        ...
        const filteredGroups = (0, react.useMemo)(() => {
          ...
          const favoriteRank = (session) => favoriteSessionIdSet.has(session.id) ? 0 : 1;
        ...
        const unfavoritedTarget = deleteTarget?.variant === "unfavorited";
        const deleteDialogTitle = unfavoritedTarget ? t("archives.deleteUnfavoritedTitle") : batchScope === "all" ? t("archives.deleteAllTitle") : batchScope === "ungrouped" ? t("archives.deleteUngroupedTitle") : batchScope === "workspace" ? t("archives.deleteProjectTitle", { name: deleteTarget.title }) : batchScope === "sessions" ? t("archives.deleteSelectedTitle") : t("deleteSession.title");
        const deleteDialogDescription = deleteTarget === null ? void 0 : unfavoritedTarget ? t(deleteTarget.filtered === true ? "archives.deleteUnfavoritedFilteredDesc" : "archives.deleteUnfavoritedAllDesc", { n: deleteTarget.count }) : batchScope === "all" ? t("archives.deleteAllDesc", { n: deleteTarget.count }) : batchScope === "ungrouped" ? t("archives.deleteUngroupedDesc", { n: deleteTarget.count }) : batchScope === "workspace" ? t("archives.deleteProjectDesc", { name: deleteTarget.title, n: deleteTarget.count }) : batchScope === "sessions" ? t("archives.deleteSelectedDesc", { n: deleteTarget.count }) : t("deleteSession.desc", { name: displayTitle(deleteTarget.session, t) });
        const deleteConfirmLabel = unfavoritedTarget ? t("archives.deleteUnfavoritedConfirm") : batchScope === "all" ? t("archives.deleteAll") : batchScope === "ungrouped" ? t("archives.deleteUngroupedConfirm") : batchScope === "workspace" ? t("archives.deleteProjectConfirm") : batchScope === "sessions" ? t("archives.deleteSelectedConfirm") : t("deleteSession.title");
        return (0, react_jsx_runtime.jsxs)("section", {
          ...
          }), idleProgress !== null ? (0, react_jsx_runtime.jsxs)("div", { className: "dsham_settingsIdleProgress", children: [(0, react_jsx_runtime.jsxs)("span", { className: "dsham_settingsIdleProgressText", children: [t("archives.idleProgress"), " ", (idleProgress.done || 0), " / ", (idleProgress.total || 0), "（", Math.round((idleProgress.total || 0) === 0 ? 0 : (idleProgress.done || 0) / idleProgress.total * 100), "%）", (idleProgress.failed || 0) > 0 ? "，失败 " + idleProgress.failed : ""] }), (0, react_jsx_runtime.jsx)("span", { className: "dsham_settingsIdleProgressBar", children: (0, react_jsx_runtime.jsx)("span", { className: "dsham_settingsIdleProgressFill", style: { width: Math.round((idleProgress.total || 0) === 0 ? 0 : (idleProgress.done || 0) / idleProgress.total * 100) + "%" } }) })] }) : null, (0, react_jsx_runtime.jsx)("div", { className: "dsham_settingsIdleNote", children: t("archives.idleNote") })] }), (0, react_jsx_runtime.jsxs)("div", {
          className: "dsham_settingsToolbar",
            ...
            }), (0, react_jsx_runtime.jsxs)("button", { type: "button", className: "dsham_settingsFavoritesToggle", "data-active": favoritesOnly, "aria-pressed": favoritesOnly, "aria-label": t("archives.onlyFavoritesAria"), title: t("archives.onlyFavoritesAria"), disabled: busy, onClick: () => setFavoritesOnly((current) => !current), children: [(0, react_jsx_runtime.jsx)(ArchiveStarIcon, { filled: favoritesOnly }), t("archives.onlyFavorites")] }), favoriteCount > 0 ? (0, react_jsx_runtime.jsx)("span", { className: "dsham_settingsFavoritesCount", children: t("archives.favoriteCount", { n: favoriteCount }) }) : null, turnsStatus === "loading" || turnsStatus === "failed" ? (0, react_jsx_runtime.jsx)("span", { className: "dsham_settingsFavoritesCount", children: t(turnsStatus === "loading" ? "archives.turnsLoading" : "archives.turnsFailed") }) : null, (0, react_jsx_runtime.jsx)(ArchiveProjectSelect, { id: "dsham-sort-filter", value: sortBy, options: [{ value: "updated", label: t("archives.sortUpdated") }, { value: "created", label: t("archives.sortCreated") }, { value: "turns", label: t("archives.sortTurns") }, { value: "alphabetical", label: t("archives.sortAlphabetical") }], onChange: setSortBy, "aria-label": t("archives.sortBy") }), (0, react_jsx_runtime.jsx)(ArchiveProjectSelect, { id: "dsham-project-filter", value: project, options: [{ value: "all", label: t("archives.allProjects") }, ...sortedGroups.map((group) => ({ value: group.key, label: group.title }))], onChange: setProject, "aria-label": t("archives.projectFilter") }), (0, react_jsx_runtime.jsxs)("button", { type: "button", className: "dsham_settingsDangerQuiet", disabled: busy || unfavoritedVisibleIds.length === 0, title: t("archives.deleteUnfavoritedTitle"), onClick: () => setDeleteTarget({ kind: "batch", variant: "unfavorited", filtered: true, target: { scope: "sessions", sessionIds: unfavoritedVisibleIds }, count: unfavoritedVisibleIds.length }), children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconTrashOutline16, {}), t("archives.deleteUnfavoritedFiltered")] })]
          ...
          }), groups.length === 0 ? (0, react_jsx_runtime.jsx)("div", { className: "dsham_settingsEmpty", children: t("archives.empty") }) : filteredGroups.length === 0 ? (0, react_jsx_runtime.jsx)("div", { className: "dsham_settingsEmpty", children: favoritesOnly === true && favoriteCount === 0 ? t("archives.favoriteEmpty") : t("archives.emptyFiltered") }) : filteredGroups.map((group) => {
      ...
      const tagId$2 = "dsh-archive-manager-pro/Rows.module.css";
      ...
      function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onUnarchive, onDeleteSession, drag, flat = false, t }) {
        ...
        const sessionMenuItems = [
          ...sessionClipboardMenuItems(t, favorite, pinned),
          ...(archived ? [
            {
              id: "unarchive",
      ...
      const tagId$1 = "dsh-archive-manager-pro/WorkspacePicker.module.css";
      ...
      const tagId = "dsh-archive-manager-pro/WorkspaceBrowser.module.css";
      ...
      const ARCHIVE_SETTINGS_SELECTION_CSS = ".dsham_settingsSelection{display:flex;align-items:center;gap:10px;min-height:40px;margin:-8px 0 16px;padding:4px 10px;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-button-elevated-fill))}.dsham_settingsSelectionToggle{display:inline-flex;align-items:center;gap:8px;min-width:0;color:var(--dsw-alias-label-primary);font-size:13px;cursor:pointer}.dsham_settingsCheckbox{width:16px;height:16px;margin:0;accent-color:#3b82f6}.dsham_settingsSelectionCount{margin-right:auto;color:var(--dsw-alias-label-tertiary);font-size:12px}.dsham_settingsSelectionAction{min-height:28px;padding:0 10px;color:var(--dsw-alias-label-primary);background:transparent;border:1px solid var(--dsw-alias-border-l2);border-radius:7px;cursor:pointer;font:inherit;font-size:12px;font-weight:500}.dsham_settingsSelectionAction:hover{background:var(--dsw-alias-interactive-bg-hover)}.dsham_settingsSelectionDelete{color:var(--dsw-alias-state-error-primary);border-color:var(--dsw-alias-state-error-primary)}.dsham_settingsSelectionAction:disabled{cursor:not-allowed;opacity:.5}@media(max-width:720px){.dsham_settingsSelection{flex-wrap:wrap}.dsham_settingsSelectionCount{margin-right:0}.dsham_settingsSelectionAction{margin-left:auto}.dsham_settingsSelectionAction+.dsham_settingsSelectionAction{margin-left:-2px}}.dsham_settingsToolbar{flex-wrap:wrap}.dsham_settingsStar{display:inline-flex;align-items:center;justify-content:center;width:26px;height:26px;flex:none;padding:0;color:var(--dsw-alias-label-tertiary);background:transparent;border:0;border-radius:50%;cursor:pointer}.dsham_settingsStar:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.dsham_settingsStar[data-favorite=true]{color:#f5a623}.dsham_settingsStar:focus-visible{outline:2px solid var(--dsw-alias-label-tertiary);outline-offset:2px}.dsham_settingsStar:disabled{cursor:not-allowed;opacity:.5}.dsham_settingsFavoritesToggle{display:inline-flex;align-items:center;gap:6px;min-height:32px;padding:0 12px;flex:none;color:var(--dsw-alias-label-primary);background:transparent;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;cursor:pointer;font:inherit;font-size:12px;font-weight:500}.dsham_settingsFavoritesToggle:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.dsham_settingsFavoritesToggle[data-active=true]{color:#f5a623;border-color:#f5a623;background:color-mix(in srgb,#f5a623 14%,transparent)}.dsham_settingsFavoritesCount{display:inline-flex;align-items:center;min-height:32px;color:var(--dsw-alias-label-tertiary);font-size:12px}.dsham_settingsDangerQuiet{display:inline-flex;align-items:center;gap:6px;min-height:32px;padding:0 12px;flex:none;color:var(--dsw-alias-state-error-primary);background:transparent;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;cursor:pointer;font:inherit;font-size:12px;font-weight:500}.dsham_settingsDangerQuiet:hover:not(:disabled){border-color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb,var(--dsw-alias-state-error-primary) 12%,transparent)}.dsham_settingsDangerQuiet:disabled,.dsham_settingsFavoritesToggle:disabled{cursor:not-allowed;opacity:.5}.dsham_copyNotice{color:var(--dsw-alias-state-success-primary,#3fb950)!important;font-size:11px;white-space:nowrap}.dsham_pinBadge{display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;flex:none;color:#f5a623}.dsham_favoriteBadge{display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;flex:none;color:#f5a623}.dsham_settingsIdleCard{display:flex;flex-direction:column;gap:8px;margin-bottom:14px;padding:12px 14px;background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-button-elevated-fill));border:1px solid var(--dsw-alias-border-l2);border-radius:12px}.dsham_settingsIdleTitle{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:600;line-height:20px}.dsham_settingsIdleRow{display:flex;flex-wrap:wrap;align-items:center;gap:10px}.dsham_settingsIdleLabel{display:inline-flex;align-items:center;gap:6px;color:var(--dsw-alias-label-secondary);font-size:12px}.dsham_settingsIdleInput{box-sizing:border-box;width:72px;min-height:28px;padding:0 8px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-3,var(--dsw-alias-button-elevated-fill));border:1px solid var(--dsw-alias-border-l2);border-radius:7px;font:inherit;font-size:12px}.dsham_settingsIdleInput:focus{outline:none;border-color:var(--dsw-alias-label-tertiary)}.dsham_settingsIdleHint{color:var(--dsw-alias-label-tertiary);font-size:12px;font-variant-numeric:tabular-nums}.dsham_settingsIdleRun,.dsham_settingsIdleUndo{display:inline-flex;align-items:center;min-height:28px;padding:0 12px;color:var(--dsw-alias-label-primary);background:transparent;border:1px solid var(--dsw-alias-border-l2);border-radius:8px;cursor:pointer;font:inherit;font-size:12px;font-weight:500}.dsham_settingsIdleRun:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-label-tertiary)}.dsham_settingsIdleUndo{color:var(--dsw-alias-label-secondary)}.dsham_settingsIdleRun:disabled,.dsham_settingsIdleUndo:disabled{cursor:not-allowed;opacity:.5}.dsham_settingsIdleProgress{display:flex;align-items:center;gap:8px;margin-top:6px;font-size:12px;color:var(--dsh-text-secondary,#8a8f98)}.dsham_settingsIdleProgressText{flex:none;font-variant-numeric:tabular-nums}.dsham_settingsIdleProgressBar{flex:1;height:6px;border-radius:3px;background:rgba(127,127,127,.25);overflow:hidden}.dsham_settingsIdleProgressFill{display:block;height:100%;background:var(--dsh-accent,#4c8dff);transition:width .6s cubic-bezier(.22,.61,.36,1)}.dsham_settingsIdleAutoRow{display:flex;align-items:center;gap:10px;flex-wrap:wrap;font-size:12px;color:var(--dsw-alias-text-2,var(--dsw-alias-text-l2,#8a8f99))}.dsham_settingsIdleAutoToggle{display:inline-flex;align-items:center;gap:6px;cursor:pointer;color:var(--dsw-alias-text-l1,inherit)}.dsham_settingsIdleAutoToggle input{cursor:pointer}.dsham_settingsIdleAutoHint{opacity:.85}.dsham_settingsIdleNote{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.dsham_deleteProgress{margin-top:12px}.dsham_settingsLinks{display:none!important}.dsham_settingsRow{flex-wrap:wrap;align-items:flex-start;row-gap:8px;column-gap:10px;min-height:0;padding:12px 14px}.dsham_settingsRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.dsham_settingsList .dsham_settingsRow:last-child{border-bottom:0}.dsham_settingsContent{flex:1 1 220px}.dsham_settingsActions{flex:1 1 100%;justify-content:flex-end;align-items:center;gap:8px;padding-top:2px}.dsham_settingsToolbar{flex-wrap:wrap;gap:10px;padding:12px;background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-button-elevated-fill));border:1px solid var(--dsw-alias-border-l2);border-radius:12px;margin-bottom:16px}.dsham_settingsSearch{flex:1 1 100%}.dsham_settingsHeaderActions{flex-wrap:wrap;gap:8px;padding:10px 12px;background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-button-elevated-fill));border:1px solid var(--dsw-alias-border-l2);border-radius:12px}.dsham_settingsSelection{padding:8px 12px;border-radius:12px;margin:0 0 16px}.dsham_settingsGroup{margin:0 0 24px}.dsham_settingsGroupHeading{padding:0 2px 6px}.dsham_settingsMeta{display:flex;flex-wrap:wrap;align-items:center;gap:6px}";
      ...
      const ARCHIVE_FAVORITES_STORAGE_KEY = "dsham.favoriteArchivedSessions.v1";
      const SESSION_PATH_ENDPOINT = "/api/dsh-archive-manager-pro/session-path";
      ...
      const ARCHIVE_DIGEST_STORAGE_KEY = "dsham.sessionDigests.v1";
      const SESSION_DIGEST_ENDPOINT = "/api/dsh-archive-manager-pro/session-digest";
      ...
      const ARCHIVE_PINNED_STORAGE_KEY = "dsham.pinnedSessions.v1";
      ...
      const SIDEBAR_SORT_BY_TIME_KEY = "dsham.sidebarSortByTime.v2";
      ...
      function sessionClipboardMenuItems(t, favorite, pinned) {
        return [
          {
            id: "pin",
      ...
      const TURN_COUNTS_ENDPOINT = "/api/dsh-archive-manager-pro/archived-turn-counts";
      ...
      function sortArchivedGroups(groups, sortBy, createdAtById, t, turnCountById = {}) {
      ...
      const zh = {
        ...
        "digest.doing": "进行中 {done}/{total} · {task}",
      ...
      const en = {
        ...
        "archives.autoArchiveOnHint": "On: checks every {minutes} minutes and archives unarchived chats idle for more than {days} days.",
          "archives.deleteProgress": "Delete progress",
        ...
        "menu.favorite": "Favorite session",
        ...
        "digest.doing": "{done}/{total} in progress · {task}",
      ...
      function applyWorkspaceBrowser(ctx) {
        ...
        const archiveSessionsByIds = async (sessionIds) => {
          const registry = ctx.get("remote.workspaceRegistry");
          if (registry === void 0) throw new Error("archive-manager remote service is unavailable");

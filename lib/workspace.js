...
const ARCHIVE_MANAGER_INVOCATIONS = [
  {
    ...
    sourceLocation: {
      file: "dsh-archive-manager-pro/lib/workspace.js",
      line: 1,
      column: 1
    }
  },
    ...
    parameters: [
      {
        ...
        codec: {
          mode: "strict",
          typeSymbol: "dsh-archive-manager-pro/types#ArchivedBatchTarget",
  ...
  {
    id: "dsh-archive-manager-pro#workspaceRegistry/archiveSessionsByIds",
    service: "workspaceRegistry",
    namespace: "workspaceRegistry",
    ...
    parameters: [
      {
        ...
        codec: {
          mode: "strict",
          typeSymbol: "dsh-archive-manager-pro/types#IdleArchiveSessionIds",
    ...
    result: {
      mode: "strict",
      typeSymbol: "dsh-archive-manager-pro/types#ArchivedSelectionBatch",
  ...
  {
    id: "dsh-archive-manager-pro#workspaceRegistry/deleteArchivedSessionsSafe",
    service: "workspaceRegistry",
    namespace: "workspaceRegistry",
